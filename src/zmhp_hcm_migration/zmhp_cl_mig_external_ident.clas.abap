class ZMHP_CL_MIG_EXTERNAL_IDENT definition
  public
  create public .
...
CLASS ZMHP_CL_MIG_EXTERNAL_IDENT IMPLEMENTATION.
  ...
  METHOD constructor.
    ...
    IF cogl EQ abap_true OR
       cogu EQ abap_true.
      vp_external_ident_data = VALUE #( ( name = 1  value = zmhp_cl_mig_utils=>merge )
