class ZMHP_CL_MIG_NATIO_IDENTIFIER definition
  public
  final
  create public .
...
CLASS ZMHP_CL_MIG_NATIO_IDENTIFIER IMPLEMENTATION.
...
METHOD constructor.
  ...
  ELSEIF cofu EQ abap_true.
    vp_natio_identifier_struc = VALUE #( ( name = 1  value = zmhp_cl_mig_utils=>merge  )
