...
REPORT zmhp_int_test_xml.
*DATA:
*  lt_data    TYPE zmhp_cl_int_xml=>tt_data,
...
*  EXPORTING
*    logical_filename = 'ZMHP_HCM_ORACLE_EXTRACTS'
...
*    xml_document = xml ).
*
*DATA(lo_object) = NEW zmhp_cl_int_object_xml( ).
...
**  DATA(lo_employee) = zmhp_cl_int_infty_proc_xml=>get_instance( molga = '01' xml_node = <object>-xml_node cloud_id = CONV #( <object>-id_cloud ) sap_id = CONV #( <object>-id_sap ) ).
*  <object>-employee_processor = NEW zmhp_cl_int_employee_xml( molga = <object>-molga xml_node = <object>-xml_node cloud_id = CONV #( <object>-id_cloud ) sap_id = CONV #( <object>-id_sap ) ).
...
*  DATA(infotype_changes) = NEW zmhp_cl_int_it_aend( ).
