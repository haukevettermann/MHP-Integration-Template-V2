class ZMHP_CL_INT_TYPE_CAST definition
  public
  final
  create public .

*"* public components of class ZMHP_CL_INT_TYPE_CAST
*"* do not include other source files here!!!
public section.

  types:
    BEGIN OF zmhp_wplog.
      INCLUDE TYPE zmhp_wplog.
*    INCLUDE TYPE wplog.
*    TYPES aend_id TYPE guid_32.
    TYPES END OF zmhp_wplog .
  types:
    zmhp_tt_WPLOG_tab TYPE TABLE OF zmhp_wplog .
  ...
  class-methods PNNNN_TO_PRELP_TAB
    importing
      ...
      !AEND_ID_TAB type ZMHP_TT_VALUE
    exporting
      !PRELP_TAB type ZMHP_TT_PRELP_TAB .
  ...
  class-methods WPLOG_TO_PNNNN_TAB
    importing
      !WPLOG_TAB type ZMHP_CL_INT_TYPE_CAST=>ZMHP_TT_WPLOG_TAB
      !AEND_ID_TAB type ZMHP_TT_VALUE
    exporting
      !PNNNN_TAB type TABLE .
  ...
  class-methods PRELP_TO_VIEW
    ...
    exporting
      ...
      !SECONDARY_RECORD type ANY .
protected section.
*"* protected components of class ZMHP_CL_INT_TYPE_CAST
*"* do not include other source files here!!!
private section.
*"* private components of class ZMHP_CL_INT_TYPE_CAST
*"* do not include other source files here!!!
...
CLASS ZMHP_CL_INT_TYPE_CAST IMPLEMENTATION.
...
METHOD pnnnn_to_prelp_tab.
  DATA prelp TYPE zmhp_prelp.

  FIELD-SYMBOLS <prelp> TYPE c.
  FIELD-SYMBOLS <pnnnn> TYPE any.
  FIELD-SYMBOLS <prelp_new> TYPE zmhp_prelp.
...
METHOD wplog_to_pnnnn_tab .
  ...
  DATA wplog TYPE zmhp_cl_int_type_cast=>zmhp_wplog.
