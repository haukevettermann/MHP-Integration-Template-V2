class ZMHP_CL_INT_CONSTANTS definition
  public
  final
  create public .
...
public section.
  ...
  constants:
    BEGIN OF mandant.
    CONSTANTS homag     TYPE mandt VALUE '901'.
    CONSTANTS durr      TYPE mandt VALUE '210'.
    CONSTANTS END OF mandant .
  constants:
  ...
  constants MSG_CLASS_INT type STRING value 'ZMHP_HCM_INTEGRATION' ##NO_TEXT.
...
*  constants PLANS type STRING value 'PLANS' ##NO_TEXT.
  ...
  constants HFMCODE type STRING value 'HFMCODE' ##NO_TEXT.
  ...
  constants INTEGRATION_RUN_ID_PATH_POS type STRING value '//request_id' ##NO_TEXT.
  constants COUNTRY_CODE_PATH type STRING value '//Country' ##NO_TEXT.
  constants COUNTRY_CODE_PATH_DT type STRING value '/Details/AccountingArea' ##NO_TEXT.
  constants COUNTRY_CODE_PATH_RPT type STRING value '//COUNTRY' ##NO_TEXT.
  constants COUNTRY_CODE_PATH_OM type STRING value '/CostCenterData/Identifier' ##NO_TEXT.
...
*    CONSTANTS END OF non_relevant_actions .
  ...
  constants IT0033 type STRING value '0033' ##NO_TEXT.
  ...
  constants BUKRS type STRING value 'BUKRS' ##NO_TEXT.
  constants PGP_PASSPHRASE type STRING value 'Du3rr_PgPK3y#D3v1_2022#!' ##NO_TEXT.
  constants DECRYPT_COMMAND type SXPGCOLIST-NAME value 'ZHR_PGP_DECRYPT' ##NO_TEXT.
  constants ENCRYPT_COMMAND type SXPGCOLIST-NAME value 'ZHR_PGP_ENCRYPT' ##NO_TEXT.
...
CLASS ZMHP_CL_INT_CONSTANTS IMPLEMENTATION.
