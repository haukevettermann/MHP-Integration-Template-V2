@AbapCatalog.sqlViewName: 'ZMHP_INT_V_CUN'
...
@EndUserText.label: 'MHP Integration Center PA/OM Union'

define view ZMHP_INT_CENTER_UN as

  select from zmhp_int_it_aend as aend

    left outer to one join zmhp_int_msg_p as p on  aend.int_run   = p.int_run
    ...
    cast( aend.cloud_pernr as ZMHP_DD_ELEMENT ) as cloud_id,
...
select from zmhp_int_it_aeup as aend
...
select from zmhp_int_om_aend as aend
