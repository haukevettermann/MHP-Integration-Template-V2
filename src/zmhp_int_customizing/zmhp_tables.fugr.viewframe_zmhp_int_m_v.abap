*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMHP_INT_M_V
*   generation date: 18.11.2021 at 09:52:07
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMHP_INT_M_V        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMHP_INT_M_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMHP_INT_M_V_EXTRACT
TOTAL = ZMHP_INT_M_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMHP_INT_M_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMHP_INT_M_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMHP_INT_M_V_EXTRACT
TOTAL = ZMHP_INT_M_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMHP_INT_M_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMHP_INT_M_V'
...
TOTAL = ZMHP_INT_M_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMHP_INT_M_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMHP_INT_M_V-UPD_FLAG NE SPACE.
