@AbapCatalog.sqlViewName: 'ZMHP_INT_V_CLE'
...
define view ZMHP_INT_CENTER_LE as

select from ZMHP_INT_CENTER_UN as un

    inner join zmhp_int_msg_l as msg     on un.aend_id   = msg.aend_id 
