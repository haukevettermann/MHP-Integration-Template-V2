class ZMHP_CL_HRPA_INFTY_0003 definition
  public
  inheriting from CL_HRPA_INFTY_NNNN
  final
  create public .

*"* public components of class ZMHP_CL_HRPA_INFTY_0003
...
protected section.
*"* protected components of class ZMHP_CL_HRPA_INFTY_0003
*"* do not include other source files here!!!
  ...
  methods VERSIONID
    redefinition .
private section.
*"* private components of class ZMHP_CL_HRPA_INFTY_0003
*"* do not include other source files here!!!
...
CLASS ZMHP_CL_HRPA_INFTY_0003 IMPLEMENTATION.
...
*    RAISE EXCEPTION TYPE cx_hrpa_violated_precondition.
    is_ok = abap_false.
    data(msg) = VALUE symsg( msgty = 'E' msgid = 'ZMHP_INTEGRATION' msgno = 031 ).
