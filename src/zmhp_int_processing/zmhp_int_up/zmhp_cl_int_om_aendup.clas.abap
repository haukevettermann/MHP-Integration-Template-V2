class ZMHP_CL_INT_OM_AENDUP definition
  public
  final
  create public .
...
public section.
  ...
  methods ENHANCE_ENTRIES
    importing
      !AEND_NEW type ZMHP_INT_OM_AEUP
    exporting
      !OM_AEND type ZMHP_INT_OM_AEUP
...
CLASS ZMHP_CL_INT_OM_AENDUP IMPLEMENTATION.


  METHOD BUILD_OM_AEND_UP.
    DATA om_aendup_orig TYPE zmhp_int_om_aeup.
  ...
  METHOD ENHANCE_ENTRIES.
    ...
    IF aend_new IS NOT INITIAL.
      ...
      om_aend-int_run = zmhp_cl_int_utility=>create_guid( ).
  ...
  METHOD SAVE_ENTRIES.
    MODIFY zmhp_int_om_aeup FROM om_aendup.
