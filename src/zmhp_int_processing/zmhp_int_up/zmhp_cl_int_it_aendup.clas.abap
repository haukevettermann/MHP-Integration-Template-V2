class ZMHP_CL_INT_IT_AENDUP definition
  public
  final
  create public .
...
public section.
  ...
  methods ENHANCE_ENTRIES
    importing
      !AEND_NEW type ZMHP_INT_IT_AEUP
    exporting
      !IT_AEND type ZMHP_INT_IT_AEUP
...
CLASS ZMHP_CL_INT_IT_AENDUP IMPLEMENTATION.


  METHOD build_it_aend_up.
    DATA it_aendup_orig TYPE zmhp_int_it_aeup.
  ...
  METHOD enhance_entries.
    ...
    IF aend_new IS NOT INITIAL.
      ...
      it_aend-int_run = zmhp_cl_int_utility=>create_guid( ).
  ...
  METHOD save_entries.
    MODIFY zmhp_int_it_aeup FROM it_aendup.
