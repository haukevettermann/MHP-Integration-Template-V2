...
START-OF-SELECTION.
  ...
  DATA(lo_it_aend) = NEW zmhp_cl_int_it_aend( ).
...
END-OF-SELECTION.
  ...
  DATA(it_aend_post) = NEW zmhp_cl_it_aend_post( alv   = pa_alv
                                                 batch = sy-batch
                                                 simu  = pa_simu
  ...
  it_aend_post->status_handler = NEW zmhp_cl_int_status_handler( sap_id_rng    = gr_pernr
                                                                  infty_rng    = inftys
...
*  SORT it_aend_post->status_handler->it_aend_action
*    BY  int_run
*       cloud_pernr
*       infty
*       begda
...
*    BY timestamp ASCENDING.
  ...
  "start post
*  IF zmhp_cl_int_utility=>check_for_om_error( ) = abap_false.
*  DATA(global_hr) = 'GLOB'.
