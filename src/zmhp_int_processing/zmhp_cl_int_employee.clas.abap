class ZMHP_CL_INT_EMPLOYEE definition
  public
  final
  create public .
...
CLASS ZMHP_CL_INT_EMPLOYEE IMPLEMENTATION.
...
*          return_tab     TYPE hrpad_return_tab,
    ...
    DATA(it_aend_tmp) = VALUE zmhp_tt_it_aend( FOR ls_it_aend IN it_aend_tab WHERE ( int_run = me->int_run AND
...
*        DATA(id_pos) = me->create_dummy_pos( begda = begda endda = zmhp_cl_int_constants=>highdate  ).
